[![Build Status](https://travis-ci.org/senacbcc/BCC-2s13-PI2-LOGIKID.png?branch=master)](https://travis-ci.org/senacbcc/BCC-2s13-PI2-LOGIKID) ProjetoPI2 - Desenvolvimento de um jogo utilizando a Allegro 5.
====================
LogiKiD 
====================
